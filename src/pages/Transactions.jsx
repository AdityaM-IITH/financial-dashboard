...
function Transactions() {
  ...
  const handleAddTransaction = () => {
    ...
    setForm({ date: '', name: '', category: '', type: 'income', amount: 0 })
    setShowForm(false)
  }
    ...
    <div>
      ...
      <div className="flex gap-3 mb-4 flex-wrap">
        ...
        <button
          ...
          className="border dark:border-gray-700 dark:text-white rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700"
        >
          ↓ Export CSV
        </button>
      </div>
